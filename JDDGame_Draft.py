...
Instructions for use:
    ...
    - Please email jdd310@gmail.com with the subject line "JDDGame Bug" if you find any bugs.
"""
...
class GameState: 
    ...
    class EnvironmentManager:
        def __init__(self, filepath, game_state):
            ...
            # Ensure environments data exists and is correctly formatted
            ...
            # Map grid locations to environment names
        ...
        def examine_area(self):
            # Print searchable information if available
            if self.current_environment:
...
class GameEngine:
    ...
    def do_examine(self):
        # Executes the examine_area function and then the program sleeps for 6 seconds
        GameUtils.clear_screen()
...
def main():
    ...
    file_path = 'CS103/FinalProject/GameData.JSON' #file path for when im working on it myself
    if not file_path:
